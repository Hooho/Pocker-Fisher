...
- 两种开局：单次赛（2 / 4 / 6 / 8 人，10,000 起始筹码）和冠军之路（256 人、9 个阶段）。
- 冠军之路前五轮八人晋级四人；冠军桌八、六、四、二、一人，筹码延续。
- 无限制下注、短筹码全下、主池/边池、平局分池、单挑盲注顺序。
- Three.js 立体牌桌、灯光、程序化桌布、筹码；清晰的平面牌张和操作界面。
- 300 名预制角色与静态 SVG 头像，搜索及档案管理。
...
`public/characters.json` 与 `public/avatars/` 为 300 人正式资源。`scripts/characters.mjs` 是构建前资源生成脚本，不在玩家开局时运行。
